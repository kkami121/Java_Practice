package week6;
/*
주어진 정수가 소수인지 여부를 판별하고 얼마 만의 시간이 걸리는지 출력하는 프로그램
...
public class PrimeAlgorithmComparison{
	public static void main(String[] args){
		...
		boolean result1 = isPrime1(n);
		endTime = System.currentTimeMillis();
		System.out.println("첫 번재 방법, 계산 시간: " + (endTime - startTime) + "ms");
		System.out.printf("%d은 소수이다: " + result1, n);

		System.out.println(" ");

		startTime = System.currentTimeMillis();
		boolean result2 = isPrime1(n);
		endTime = System.currentTimeMillis();
		System.out.println("두 번재 방법, 계산 시간: " + (endTime - startTime) + "ms");
		System.out.printf("%d은 소수이다: " + result2, n);		
		System.out.println(" ");
	}
	/*
	첫 번째 방법
